...
## Generated Output
### Root README Example
![alt text](assets/root_readme.png)
  
### Problem README Example
![alt text](assets/problem_reedme.png)
...
### Set up your environment variables:
   ...
   cp .env.example .env
   ```
   _Note: Open `.env` and fill in your local configuration values._
...
![alt text](assets/leetcode_dev.png)
